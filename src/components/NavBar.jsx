    ...
    >
      <div className="max-w-7xl mx-auto px-6 py-3.5 flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center gap-1.5 lg:gap-4 xl:gap-6">
          {tabs.map(({ label, path }) => {
            ...
            return (
              <button
                ...
                className="text-[10px] lg:text-xs font-black tracking-[0.08em] lg:tracking-[0.15em] uppercase transition-colors duration-150 select-none"
                style={{
          ...
          <a
            href="tel:3305108875"
            className="flex items-center gap-1.5 px-3 lg:px-5 py-2 lg:py-2.5 rounded-full font-black text-[10px] lg:text-xs tracking-widest uppercase transition-opacity hover:opacity-85 select-none"
