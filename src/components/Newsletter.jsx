...
export default function Newsletter() {
  ...
  return (
    <section
      ...
      style={{ background: "#fff8e8", borderTop: "1px solid rgba(180,120,0,0.1)" }}
    >
      <div className="max-w-5xl mx-auto">
        ...
        <div className="grid md:grid-cols-3 gap-5">
          ...
          >
            <div
              className="w-12 h-12 rounded-xl flex items-center justify-center mb-4 flex-shrink-0 text-2xl"
            ...
            <p className="text-sm leading-relaxed mb-5 flex-1" style={{ color: "rgba(61,34,0,0.55)" }}>
              See exactly where the truck is right now on an interactive map — updated in real time by the crew.
            </p>
            <button
          ...
          >
            ...
            {done ? (
              ...
              <form onSubmit={handleSubmit} className="flex flex-col gap-2">
                ...
                <button
                  type="submit"
                  className="py-3 rounded-full font-bold text-sm transition-opacity duration-200 hover:opacity-85"
