...
export default function Hero() {
  ...
  const { specials } = useWeeklySpecials(3);
        ...
        >
          ...
          <div className="flex flex-wrap gap-3">
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="px-7 py-3.5 rounded-full font-black text-sm tracking-widest uppercase"
              style={{ background: '#c9940a', color: '#fff', textDecoration: 'none', border: '2px solid #c9940a', transition: 'opacity 0.2s' }}
            ...
            <button
              ...
              className="px-7 py-3.5 rounded-full font-black text-sm tracking-widest uppercase"
              style={{ background: '#1a0800', color: '#fff8e8', border: '2px solid #1a0800', cursor: 'pointer', transition: 'opacity 0.2s' }}
              onMouseEnter={e => e.currentTarget.style.opacity = '0.85'}
              onMouseLeave={e => e.currentTarget.style.opacity = '1'}
            >
              \uD83D\uDCC5 Events
            ...
            <button
              ...
              className="px-7 py-3.5 rounded-full font-black text-sm tracking-widest uppercase"
              style={{ background: 'transparent', border: '2px solid #c9940a', color: '#c9940a', cursor: 'pointer', transition: 'background 0.2s' }}
