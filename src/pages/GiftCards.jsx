...
const DENOMINATIONS = [
  { amount: "$10", desc: "A great starter gift" },
  { amount: "$25", desc: "Perfect for lunch on us", popular: true },
  { amount: "$50", desc: "Treat the whole crew" },
  { amount: "$100", desc: "Go all out" },
];

export default function GiftCards() {
  return (
    <div className="min-h-screen font-sans" style={{ background: "#fffbf0" }}>
      <NavBar />
      ...
      <PageTransition>
        ...
        <div className="max-w-lg mx-auto px-6 py-10 flex flex-col gap-10">
            ...
            <div className="grid grid-cols-2 gap-4">
              {DENOMINATIONS.map((d, i) => (
                <motion.a
                  ...
                  className="relative flex flex-col items-center justify-center gap-2 rounded-2xl py-7 px-4 text-center"
                  style={{
          ...
          <motion.a
            ...
            className="w-full py-5 rounded-2xl font-black text-base uppercase tracking-widest text-center block"
            style={{
              background: "#c9940a",
              color: "#fff8e8",
              textDecoration: "none",
